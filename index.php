...
<html lang="en">
	...
	<body>
		<div id="head">
			<center><h2>Facial Emotion Detection System</h2></center>
		</div><br>
		...
		<div id="content">
			...
			<button onclick="myFunction()">Click here to see videos</button>
			<p id="text"></p>
			<script>
				...
				function myFunction(){
					...
					window.location.href = "play.php?select="+document.getElementById('text').innerHTML;
				}
					...
					if (er) {
						...
						for (var i = 0;i < er.length;i++) {
							if (er[i].value >0.5	) {
								...
								document.getElementById("text").innerHTML= i+1;
							} else {
